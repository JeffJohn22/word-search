...
var words = [
  { "word": "SLIMS", "direction": "NW", "start": 300 }, // Example starting point
  { "word": "SAPIAN", "direction": "SE", "start": 2 }, // Example starting point
  { "word": "COFFEE", "direction": "S", "start": 281 }, // Example starting point
  { "word": "NEWS", "direction": "S", "start": 82 }, // Example starting point
  { "word": "FUN", "direction": "E", "start": 18 }, // Example starting point
  { "word": "PEOPLE", "direction": "W", "start": 140 }, // Example starting point
  { "word": "APPRECIATE", "direction": "NE", "start": 323 } // Example starting point
];
      ...
      // Used for Firefox
			...
			if (mouseMoved) {
				...
				if (checkWord()) {
					...
					if(isEndOfGame()) {
						alert("Good job!You move to Brew☕");
					}
				}
